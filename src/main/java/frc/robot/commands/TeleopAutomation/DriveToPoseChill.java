 ...
 */
public class DriveToPoseChill extends Command {
    ...
    public DriveToPoseChill(Supplier<Pose2d> pose) {
    ...
    public void initialize() {
        ...
        if(initialPose.getTranslation().getDistance(targetPose.getTranslation()) < 0.15){
          this.end(false);
        } 
